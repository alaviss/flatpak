...
static gboolean opt_do_redirect;
static gboolean opt_no_redirect;
...
static GOptionEntry common_options[] = {
  ...
  { "redirect", 0, G_OPTION_FLAG_REVERSE, G_OPTION_ARG_NONE, &opt_do_redirect, N_("Follow the redirect set in the summary file"), NULL },
  { "no-redirect", 0, G_OPTION_FLAG_REVERSE, G_OPTION_ARG_NONE, &opt_no_redirect, N_("Don't follow the redirect set in the summary file"), NULL },
  { NULL }
};
